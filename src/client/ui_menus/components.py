...
class Button:
    ...
    def draw(self, surface: pygame.Surface) -> None:
        ...
        if not self.enabled:
            pygame.draw.rect(surface, c["bg_disabled"], self.rect, border_radius=self._radius)
            pygame.draw.rect(surface, c["border_disabled"], self.rect, width=2, border_radius=self._radius)
        ...
        pygame.draw.rect(surface, border, self.rect, width=2, border_radius=self._radius)
